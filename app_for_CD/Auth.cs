...
namespace app_for_CD
{
    public partial class Auth : Form
    {
        ...
        private void check_registration_of_invoice(OracleCommand cmd)
        {
            ...
            {
                cmd.CommandText = "CREATE TABLE REGISTRATION_OF_INVOICE (  ID NUMBER NOT NULL , CRP VARCHAR2(12 BYTE) NOT NULL , SER VARCHAR2(20 BYTE) NOT NULL , SERVICE_T VARCHAR2(100 BYTE) , SUM_T NUMBER , CURRENCY VARCHAR2(10 BYTE) , BASIS VARCHAR2(300 BYTE) , COMMENT_T VARCHAR2(300 BYTE) , NDS_PINFL VARCHAR2(14 BYTE) , DATE_T VARCHAR2(8 BYTE) , CRP_NM VARCHAR2(300 BYTE) , INN VARCHAR2(50 BYTE) , IF_FIZ VARCHAR2(2 BYTE) , DATE_CON VARCHAR2(8 BYTE) , FIO VARCHAR2(100 BYTE) , STATUS VARCHAR2(2 BYTE) , NUM_OF_SER VARCHAR2(10 BYTE) , PROCESS VARCHAR2(3 BYTE) , SUM_PAID NUMBER ) ";
                cmd.CommandType = CommandType.Text;
                cmd.ExecuteNonQuery();
